            ...
            <div className="flex flex-col gap-4">
              <div className="card !p-5 bg-white flex flex-col mb-0 rounded-[16px]">
                ...
                <div className="grid grid-cols-1 gap-2 mb-4">
                  {/* 优化预览按钮样式：白底蓝框蓝字 */}
                  <button onClick={() => setShowPreview(true)} className="flex items-center justify-center gap-2 py-2.5 text-[14px] font-bold border-2 border-[#0062AD] text-[#0062AD] bg-white rounded-[8px] hover:bg-[#F0F7FF] transition-all shadow-none"><Eye className="w-4 h-4" /> 预览报价单</button>
