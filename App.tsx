  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-2 gap-x-12 items-start">
        <div className="flex flex-col gap-y-4"><div className="mb-2"><div className="flex items-center gap-3 border-l-4 border-[#0062AD] pl-4 mb-3"><h4 className="text-[21px] font-bold text-[#304166]">中国质量认证中心 <span className="font-en">(CQC)</span></h4></div><p className={introClass}>中国质量认证中心(CQC)是由中国政府批准设立、认证机构批准书编号为001号的质量服务机构，隶属于中国中检集团。同时CQC也是世界最大认证机构联盟——国际认证联盟（IQNet）中国区域的两大成员之一。</p></div><div className="bg-[#f8fafc] rounded-[12px] p-5 flex items-start gap-4 border border-gray-100"><div className="w-10 h-10 rounded-[8px] bg-white flex items-center justify-center text-[#0062AD] shadow-sm shrink-0"><Award className="w-5 h-5" /></div><div className="space-y-1.5"><div className="flex items-center gap-3"><span className="text-[14px] font-bold text-[#304166]">权威地位</span><span className="px-2 py-0.5 bg-[#304166] text-white rounded-md text-[10px] font-black font-num tracking-wider">No. 001</span></div><p className="text-[13px] text-gray-500 siding-relaxed">国家认监委批准设立的专业认证机构，机构批准号：001。</p></div></div><div className="bg-[#f8fafc] rounded-[12px] p-5 flex items-start gap-4 border border-gray-100"><div className="w-10 h-10 rounded-[8px] bg-white flex items-center justify-center text-[#0062AD] shadow-sm shrink-0"><Globe className="w-5 h-5" /></div><div className="space-y-1 flex-1"><div className="flex items-center gap-3"><span className="text-[14px] font-bold text-[#304166]">国际合作</span>{['IQNet', 'IECEE'].map(tag => <span key={tag} className="px-2 py-0.5 border border-gray-200 text-gray-400 rounded-md text-[10px] font-bold font-en">{tag}</span>)}</div><p className="text-[12.5px] text-gray-500 siding-snug line-clamp-3">代表中国加入国际认证联盟及国际电工委员会合格评定体系，实现“一张证书，全球通行”。</p></div></div><div className="bg-[#f8fafc] rounded-[12px] p-5 flex items-start gap-4 border border-gray-100"><div className="w-10 h-10 rounded-[8px] bg-white flex items-center justify-center text-[#0062AD] shadow-sm shrink-0"><Grid className="w-5 h-5" /></div><div className="space-y-1 flex-1"><div className="flex items-center gap-3"><span className="text-[14px] font-bold text-[#304166]">业务覆盖</span></div><p className="text-[12.5px] text-gray-500 siding-snug line-clamp-3">提供强制性产品认证 (CCC)、自愿性认证、节能环保认证及国际管理体系认证等全方位服务。</p></div></div></div>
                ...
                <div className="overflow-hidden border border-gray-200 rounded-[12px]" style={{ textAlign: 'left', backgroundColor: '#f8fafc' }}>
                  <table className="w-full text-sm border-collapse" style={{ tableLayout: 'fixed' }}>
                    <thead className="bg-[#F8FAFC] text-[#0062AD]">
                      <tr>{block.tableData?.[0].map((cell, i) => (<th key={i} className="px-4 py-3 text-left font-bold border-b border-gray-200" style={{ width: block.columnWidths ? `${block.columnWidths[i]}%` : 'auto' }}>{cell}</th>))}</tr>
                    </thead>
