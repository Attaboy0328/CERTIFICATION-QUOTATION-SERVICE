...
const STEP_COLORS = [
  { bg: "bg-[#EFF5FC]", text: "text-[#2759CD]", num: "text-[#2759CD]/10", tag: "bg-white text-[#2759CD]" },
...
const COMMON_LOGOS = [
  { id: 'logo-cqc', url: 'https://img.meituan.net/content/a9cfaa78007ceea1101b8524ce9d309c121236.png', name: '中国质量认证中心 (CQC)' },
  { id: 'logo-ccic', url: 'https://img.meituan.net/content/ced347feedea9d2757a88ba1715be430123826.png', name: '中国检验认证集团 (CCIC)' },
];
...
const COMMON_CERT_TEMPLATES = [
  { id: 'tmpl-9001', name: 'ISO 9001', url: 'https://img.meituan.net/content/620c76a530d36a660c242ed3152269db122283.jpg', icon: Award, color: '#2759CD', bg: 'bg-blue-50' },
  { id: 'tmpl-14001', name: 'ISO 14001', url: 'https://img.meituan.net/content/3ccc27ced4f9bf95fa7683230387ef49784402.png', icon: Leaf, color: '#00b050', bg: 'bg-green-50' },
  { id: 'tmpl-45001', name: 'ISO 45001', url: 'https://img.meituan.net/content/91791127617cb6576ae72e561f5aff746371.jpg', icon: ShieldCheck, color: '#EE4932', bg: 'bg-red-50' },
  { id: 'tmpl-50430', name: 'GB/T 50430', url: 'https://wp-cdn.4ce.cn/v2/9iAa0uV.png', icon: Building, color: '#b45309', bg: 'bg-amber-50' },
  { id: 'tmpl-22000', name: 'ISO 22000', url: 'https://img.meituan.net/content/ae1ad2f2018fb84d32a2c8962a5b9e4d816055.png', icon: Utensils, color: '#0d9488', bg: 'bg-teal-50' },
  { id: 'tmpl-haccp', name: 'HACCP', url: 'https://img.meituan.net/content/0516a23e36f6d7e7bf2c28dd8e3d0ea6788539.png', icon: FlaskConical, color: '#7c3aed', bg: 'bg-purple-50' },
  { id: 'tmpl-fssc', name: 'FSSC 22000', url: 'https://img.meituan.net/content/97dfb7c37cf436518793f298c11f7fb7785442.png', icon: ShoppingBag, color: '#db2777', bg: 'bg-pink-50' },
  { id: 'tmpl-brc', name: 'BRCGS', url: 'https://img.meituan.net/content/5e475a203e3d540d5d6bce57fd78581a757584.png', icon: Box, color: '#4b5563', bg: 'bg-gray-50' },
  { id: 'tmpl-globalgap', name: 'GLOBALGAP', url: 'https://img.meituan.net/content/284ee855c26e943ecdb2c23546add4d6797178.png', icon: Globe, color: '#2563eb', bg: 'bg-blue-50' },
  { id: 'tmpl-chinagap', name: 'CHINAGAP', url: 'https://img.meituan.net/content/defc983ba30ad25980b6dd454be7466c745172.png', icon: Globe, color: '#16a34a', bg: 'bg-green-50' },
  { id: 'tmpl-27001', name: 'ISO 27001', url: 'https://img.meituan.net/content/7f768236bc961db18d98e7ae28d851c9746067.jpg', icon: Lock, color: '#1e293b', bg: 'bg-slate-50' },
  { id: 'tmpl-20000', name: 'ISO 20000', url: 'https://img.meituan.net/content/7f768236bc961db18d98e7ae28d851c9746067.jpg', icon: Monitor, color: '#0284c7', bg: 'bg-sky-50' },
  { id: 'tmpl-37301', name: 'ISO 37301', url: 'https://img.meituan.net/content/c99fc5ff7476ca4f17c618374ec3986c819136.png', icon: Gavel, color: '#c2410c', bg: 'bg-orange-50' },
  { id: 'tmpl-16949', name: 'IATF 16949', url: 'https://img.meituan.net/content/079301a46bb479efbd1de801f9575248657123.jpg', icon: Car, color: '#4338ca', bg: 'bg-indigo-50' },
  { id: 'tmpl-8000', name: 'SA 8000', url: 'https://img.meituan.net/content/6b61ef73e0f5b4a01ccb4d31e682fd0d837485.png', icon: Heart, color: '#e11d48', bg: 'bg-rose-50' },
  { id: 'tmpl-50001', name: 'ISO 50001', url: 'https://img.meituan.net/content/f90130b6125b4085a6814ad40a762901770407.png', icon: Zap, color: '#f59e0b', bg: 'bg-amber-50' },
  { id: 'tmpl-13485', name: 'ISO 13485', url: 'https://wp-cdn.4ce.cn/v2/qdeJKhp.png', icon: Microscope, color: '#0891b2', bg: 'bg-cyan-50' },
  { id: 'tmpl-27922', name: 'GB/T 27922', url: 'https://wp-cdn.4ce.cn/v2/XOQ4vKG.png', icon: ShoppingBag, color: '#ea580c', bg: 'bg-orange-50' },
  { id: 'tmpl-31950', name: 'GB/T 31950', url: 'https://wp-cdn.4ce.cn/v2/KMJElkW.png', icon: UserCheck, color: '#16a34a', bg: 'bg-green-50' },
  { id: 'tmpl-iqnet', name: 'IQNET', url: 'https://img.meituan.net/content/b535a09aa493fb6030353ab07b9228b6818203.png', icon: Award, color: '#6d28d9', bg: 'bg-violet-50' }
];
...
const CertificationProcess = ({ validity = '3years' }: { validity?: '1year' | '3years' }) => {
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      ...
      case 'blue': return { bg: 'bg-[#eff6ff]', border: 'border-[#dbeafe]', text: 'text-[#2563eb]', badge: 'bg-[#dbeafe] text-[#2563eb]' };
              ...
              {stage.steps.map((step, sIdx) => (
                <React.Fragment key={step.id}>
                  <div className="bg-white rounded-[8px] p-4 shadow-sm border border-gray-100/50 flex flex-col gap-1.5 transition-all hover:scale-[1.02]">
                    ...
                    <div className="text-[12px] text-gray-400 font-medium pl-0.5 animate-fade-in">{step.desc}</div>
                  </div>
    ...
    <div draggable={isEditable} onDragStart={(e) => onDragStart(e, index)} onDragOver={(e) => { e.preventDefault(); e.stopPropagation(); }} onDrop={(e) => onDrop(e, index)} className={`group flex flex-col relative p-5 rounded-[12px] ${color.bg} overflow-hidden transition-all duration-300 border-2 h-full min-h-[220px] cursor-default ${isEditable ? 'cursor-move' : ''} border-white/50 hover:scale-[1.02] hover:border-[#2759CD]/30`} style={{ boxShadow: '0 10px 20px rgba(0,0,0,0.03)' }}>
      ...
      {isEditable && (
        <div className="absolute top-4 right-4 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-all z-20">
          <button onClick={(e) => { e.stopPropagation(); const newTags = [...step.tags, '新标签']; onUpdateTags(index, newTags); }} title="添加标签" className="p-1.5 bg-white/80 hover:bg-[#2759CD] hover:text-white text-[#2759CD] rounded-[4px] shadow-sm backdrop-blur-sm border border-[#BDD1FF]/50"><Plus className="w-3 h-3" strokeWidth={3} /></button>
    ...
    <div className="space-y-10">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch">
        <div className="lg:col-span-3 space-y-6 flex flex-col justify-between py-1">
          <div className="space-y-4"><h3 className="text-[28px] font-bold text-[#304166] tracking-tight siding-tight">中国检验认证集团 <span className="text-[#2759CD] font-en">(CCIC)</span></h3><p className={introClass}>中国检验认证集团（简称中国中检）是经国务院批准设立、由国务院国资委管理的中央企业。作为以“检验、检测、认证、标准、计量”为主业的综合性质量服务机构，机构在全球范围内提供专业、高效、一站式的质量安全服务。</p></div>
          <div className="pt-4"><div className="flex items-center gap-3 mb-4"><div className="h-[2px] bg-blue-100 flex-1"></div><span className="text-[11px] font-black text-[#2759CD] uppercase tracking-[0.2em] whitespace-nowrap">三大品牌</span><div className="h-[2px] bg-blue-100 flex-1"></div></div><div className="grid grid-cols-3 gap-4">{[{ name: '中国中检 CCIC', icon: 'https://img.meituan.net/content/85a4fc82d05398fc2174b38f3079c047286176.png' }, { name: '中国质量认证中心 CQC', icon: 'https://img.meituan.net/content/3c7d0f7f8939199ffc2353fd439669e9284944.png' }, { name: '中国汽研 CAERI', icon: 'https://img.meituan.net/content/277ebe8f724c51cf401237b50ba688a051357.jpg' }].map((sub, i) => (<div key={i} className="bg-white rounded-[12px] p-4 border border-gray-100 shadow-sm flex flex-col items-center justify-center gap-3 transition-transform hover:scale-105 min-h-[110px]"><div className="h-14 w-full flex items-center justify-center"><img src={sub.icon} alt={sub.name} loading="lazy" className="max-h-full max-w-full object-contain" /></div><span className="text-[11px] font-bold text-gray-400 text-center whitespace-nowrap">{sub.name}</span></div>))}</div></div>
        </div>
        <div className="lg:col-span-2 grid grid-cols-2 gap-x-8 gap-y-10 pl-8 border-l border-gray-100 flex wrap items-center py-1">{[{ label: '国家和地区服务网络', value: '30', unit: '+', icon: <Globe className="w-5 h-5 text-[#2759CD]" /> }, { label: '分支机构全球布局', value: '400', unit: '+', icon: <Building className="w-5 h-5 text-[#2759CD]" /> }, { label: '专业化实验室', value: '500', unit: '+', icon: <FlaskConical className="w-5 h-5 text-[#2759CD]" /> }, { label: '全球专业技术员工', value: '20000', unit: '+', icon: <Users className="text-[#2759CD] w-5 h-5" /> }, { label: '国际权威认可资质', value: '100', unit: '+', icon: <Award className="w-5 h-5 text-[#2759CD]" /> }, { label: '国家级认可资质', value: '300', unit: '+', icon: <ShieldCheck className="w-5 h-5 text-[#2759CD]" /> }].map((stat, i) => (<div key={i} className="flex flex-col gap-1.5"><div className="mb-1">{stat.icon}</div><div className="flex items-baseline gap-0.5"><span className="text-[26px] font-bold text-[#304166] font-num leading-none">{stat.value}</span><span className="text-[16px] font-bold text-[#2759CD] font-en font-num">{stat.unit}</span></div><span className="text-[12px] font-bold text-gray-400 whitespace-nowrap">{stat.label}</span></div>))}</div></div>
...
const App: React.FC = () => {
  ...
  const dynamicTitle = useMemo(() => {
    const hasCert = data.modules.some(m => m.type === 'cert');
    const hasTech = data.modules.some(m => m.type === 'tech');
  ...
  const dynamicSubtitle = useMemo(() => {
    const hasCert = data.modules.some(m => m.type === 'cert');
    const hasTech = data.modules.some(m => m.type === 'tech');
    if (hasCert && hasTech) return "CERTIFICATION QUOTATION SERVICE";
    if (!hasCert && hasTech) return "TECHNICAL SERVICE QUOTATION";
    if (hasCert && !hasTech) return "CERTIFICATION QUOTATION";
    return "CERTIFICATION QUOTATION SERVICE";
  }, [data.modules]);
  ...
  const QuoteDocument = ({ containerRef, isPrint = false, style = {} }: { containerRef?: React.RefObject<HTMLDivElement | null>, isPrint?: boolean, style?: React.CSSProperties }) => {
    ...
    if (isNote2Visible) visibleNotes.push({ id: 'note2', content: data.travelExpenseOption === 'excluded' ? `本报价不包括现场审核及培训指导时发生的食宿和差旅费用，根据实际合理发生由客户承担/安排。` : `本报价包括现场审核及培训指导时发生的必要的食宿和差旅费用。` });
              ...
              {block.type === 'text' ? (
                ...
                <div className="overflow-hidden border border-gray-200 rounded-[12px]" style={{ textAlign: 'left', backgroundColor: '#f8fafc' }}>
                  <table className="w-full text-sm border-collapse" style={{ tableLayout: 'fixed' }}>
                    <thead className="bg-[#304166] text-white">
                      <tr>{block.tableData?.[0].map((cell, i) => (<th key={i} className="px-4 py-3 text-left font-bold border-r border-white/10 last:border-0" style={{ width: block.columnWidths ? `${block.columnWidths[i]}%` : 'auto' }}>{cell}</th>))}</tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      {block.tableData?.slice(1).map((row, ri) => (<tr key={ri}>{row.map((cell, ci) => (<td key={ci} className="px-4 text-gray-600 border-r border-gray-200 last:border-0 font-quote" style={{ paddingBlock: `${block.rowSpacing || 12}px`, wordBreak: 'break-all', whiteSpace: 'normal', textAlign: 'right' }}>{cell}</td>))}</tr>))}
                    </tbody>
                  </table>
                </div>
              ) : (
    ...
    return (
      <div ref={containerRef} className={`${isPrint ? '' : 'mx-auto'} bg-white p-[32px] md:p-[48px] transition-all duration-300 origin-top`} style={{ minHeight: isPrint ? 'auto' : '297mm', width: currentWidth, color: textColor, fontFamily: 'var(--font-zh)', ...style }}>
        ...
        <table className="w-full mb-[48px] border-collapse"><thead><tr className="border-b-2 border-gray-900"><th className="py-4 text-left font-semibold uppercase" style={{ fontSize: `${sizeTitleModule}px`, color: deepColor }}>描述 / DESCRIPTION</th><th className="py-4 text-left font-semibold uppercase pl-40" style={{ fontSize: `${sizeTitleModule}px`, color: deepColor }}>具体项目 / PROJECT</th><th className="py-4 text-right font-semibold uppercase whitespace-nowrap" style={{ fontSize: `${sizeTitleModule}px`, color: deepColor }}>金额 / AMOUNT</th></tr></thead><tbody className="divide-y divide-gray-100">{data.modules.map(module => { if (module.type === 'cert') { const prefix = getBracketLabel(module.title, 'cert'); return module.items.map(item => (<tr key={item.id}><td className="py-6 align-top">{prefix ? (<div className="space-y-1"><p className="font-semibold text-gray-400" style={{ fontSize: `${sizeSmall + 1}px` }}>【{prefix}】</p><p className="font-semibold text-[#333333]" style={{ fontSize: `${sizeTitleModule}px` }}>{item.type}</p></div>) : (<p className="font-semibold text-[#333333]" style={{ fontSize: `${sizeTitleModule}px` }}>{item.type}</p>)}</td><td className="py-6 pl-40 align-top">{prefix && <p className="font-semibold text-transparent select-none mb-1" style={{ fontSize: `${sizeSmall + 1}px` }}>【{prefix}】</p>}<p className="text-[#333333] font-semibold siding-relaxed" style={{ fontSize: `${sizeTitleModule}px` }}>{item.project}</p></td><td className="py-6 text-right font-bold whitespace-nowrap font-quote align-middle" style={{ fontSize: `${sizeTitleModule + 2}px`, color: primaryColor }}><span className="mr-0.5 text-[0.8em] font-bold opacity-60">¥</span>{item.amount.toLocaleString()}</td></tr>)); } else if (module.type === 'tech') { const prefix = getBracketLabel(module.title, 'tech'); const activeServices = module.services.filter(s => s.checked).map(s => s.name); const serviceChunks = []; for (let i = 0; i < activeServices.length; i += 3) serviceChunks.push(activeServices.slice(i, i + 3).join('、')); const detailsStr = `指导周期：不少于（现场+远程） ${module.details.minDays} 人天，内审员证书：${module.details.auditCerts} 份`; return (<tr key={module.id}><td className="py-6 align-middle">{prefix ? (<div className="space-y-1"><p className="font-semibold text-gray-400" style={{ fontSize: `${sizeSmall + 1}px` }}>【{prefix}】</p><p className="font-semibold text-[#333333]" style={{ fontSize: `${sizeTitleModule}px` }}>专业技术服务费</p></div>) : (<p className="font-semibold text-[#333333]" style={{ fontSize: `${sizeTitleModule}px` }}>专业技术服务费</p>)}</td><td className="py-6 pl-40 align-middle"><div className="space-y-2"><div className="space-y-0.5">{serviceChunks.map((chunk, idx) => (<p key={idx} className="text-[#333333] font-semibold siding-relaxed" style={{ fontSize: `${sizeTitleModule}px` }}>{chunk}</p>))}</div><p className="text-gray-400 font-normal italic" style={{ fontSize: `${sizeText}px` }}>{detailsStr}</p></div></td><td className="py-6 text-right font-bold whitespace-nowrap font-quote align-middle" style={{ fontSize: `${sizeTitleModule + 2}px`, color: primaryColor }}><span className="mr-0.5 text-[0.8em] font-bold opacity-60">¥</span>{module.fee.toLocaleString()}</td></tr>); } return null; })}</tbody><tfoot><tr className="border-t-2 border-gray-900"><td colSpan={2} className="py-8 text-left font-bold uppercase tracking-wide" style={{ fontSize: `${sizeTitleModule}px`, color: deepColor }}>总计 GRAND TOTAL (含6%增值税)</td><td className="py-8 text-right font-bold whitespace-nowrap font-quote flex items-center justify-end gap-1" style={{ fontSize: `${sizeTitleModule * 1.9 - 4}px`, color: primaryColor }}><span className="text-[0.6em] mt-2 opacity-60">¥</span>{grandTotal.toLocaleString()}</td></tr></tfoot></table>
  ...
  const RenderModuleBlocksEditor = ({ moduleId, blocks, excelInputRef }: { moduleId: string | null, blocks: CaseBlock[], excelInputRef: React.RefObject<HTMLInputElement | null> }) => {
    return (
      <div 
        className={`min-h-[300px] rounded-[12px] p-6 border-2 border-dashed transition-all flex flex-col gap-6 ${draggingExcelTargetId === (moduleId || 'main-case') ? 'bg-[#EFF5FC] border-[#2759CD] scale-[1.01]' : 'bg-slate-50/50 border-slate-200'}`}
  ...
  return (
    <div className="max-w-[1550px] mx-auto px-6 py-10 flex flex-col lg:flex-row gap-8">
      ...
      <div className={`flex-1 max-w-[900px] transition-colors duration-300 ${isDraggingOverMain ? 'bg-[#EFF5FC]' : ''}`} onDragOver={(e) => { e.preventDefault(); setIsDraggingOverMain(true); }} onDragLeave={() => setIsDraggingOverMain(false)} onDrop={handleDropToMain}>
            ...
            <section key={module.id} className={`card overflow-hidden relative group cursor-default transition-all duration-300 border-2 ${dragOverModuleId === module.id ? 'border-[#2759CD] scale-[1.01]' : 'border-transparent hover:border-[#BDD1FF]'}`} draggable="true" onDragStart={(e) => handleDragStart(e, module.id)} onDragOver={(e) => { e.preventDefault(); setDragOverModuleId(module.id); }} onDragLeave={() => setDragOverModuleId(null)} onDrop={(e) => handleModuleReorder(e, module.id)}>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                ...
                <div className="flex gap-2">
                  {module.type === 'cert' ? (<><button onClick={() => resetCertModuleItems(module.id)} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-gray-100 text-gray-600 px-3 py-1.5 rounded-[12px] hover:bg-gray-50 transition-all"><RotateCcw className="w-3 h-3" /> 重置</button><button onClick={() => addCertItemToModule(module.id)} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-[#BDD1FF] text-[#2759CD] px-3 py-1.5 rounded-[12px] hover:bg-[#EFF5FC] transition-all"><Plus className="w-3 h-3" /> 添加阶段</button><button onClick={() => removeCertItemFromModule(module.id)} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-red-100 text-red-500 px-3 py-1.5 rounded-[12px] hover:bg-red-50 transition-all"><Minus className="w-3 h-3" /> 移除阶段</button></>) : (<><button onClick={() => resetTechModuleServices(module.id)} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-gray-100 text-gray-600 px-3 py-1.5 rounded-[12px] hover:bg-gray-50 transition-all"><RotateCcw className="w-3 h-3" /> 重置</button><button onClick={() => addTechServiceToModule(module.id)} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-[#BDD1FF] text-[#2759CD] px-3 py-1.5 rounded-[12px] hover:bg-[#EFF5FC] transition-all"><Plus className="w-3 h-3" /> 添加服务</button><button onClick={() => removeTechServiceFromModule(module.id)} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-red-100 text-red-500 px-3 py-1.5 rounded-[12px] hover:bg-red-50 transition-all"><Minus className="w-3 h-3" /> 移除服务</button></>)}
                </div>
              </div>
              {module.type === 'cert' ? (<div className="border border-gray-100 rounded-[12px] overflow-hidden shadow-sm"><table className="w-full text-[14px] border-separate border-spacing-0"><thead className="bg-[#304166] text-white"><tr><th className="px-5 py-3 text-left font-semibold first:rounded-tl-[12px]">认证阶段</th><th className="px-5 py-3 text-left font-semibold">具体收费项目</th><th className="px-5 py-3 text-right font-semibold w-40 last:rounded-tr-[12px]">金额 (CNY)</th></tr></thead><tbody className="divide-y divide-gray-100">{module.items.map((item) => (<tr key={item.id} className="hover:bg-[#EFF5FC]/30 transition-colors"><td className="p-0 border-r border-gray-50"><input className="!border-0 px-5 py-3 focus:ring-0 bg-transparent w-full text-left" value={item.type} onChange={e => handleUpdateCertItem(module.id, item.id, 'type', e.target.value)} /></td><td className="p-0 border-r border-gray-50"><input className="!border-0 px-5 py-3 focus:ring-0 bg-transparent w-full text-left" value={item.project} onChange={e => handleUpdateCertItem(module.id, item.id, 'project', e.target.value)} /></td><td className="p-0 bg-white/50 cursor-text" onClick={() => setEditingCertId({moduleId: module.id, itemId: item.id})}><div className="flex items-center justify-end px-5 py-3 gap-0.5 text-[#2759CD] font-bold font-quote text-[15px]"><span className="font-bold text-[13px] opacity-60 mr-0.5">¥</span>{editingCertId?.moduleId === module.id && editingCertId?.itemId === item.id ? (<input autoFocus className="!border-0 !p-0 focus:ring-0 bg-transparent text-right font-bold w-24 font-quote" type="number" value={item.amount} onBlur={() => setEditingCertId(null)} onChange={e => handleUpdateCertItem(module.id, item.id, 'amount', parseFloat(e.target.value) || 0)} />) : (<span>{item.amount.toLocaleString()}</span>)}</div></td></tr>))}</tbody><tfoot><tr className="bg-[#FAFAFA] border-t border-[#D1E0FF]"><td colSpan={2} className="px-5 py-5 font-bold text-[#304166] text-left first:rounded-bl-[12px]">认证费用总计（含6%增值税）</td><td className="px-5 py-5 text-right font-bold text-[#2759CD] text-[18px] whitespace-nowrap font-quote flex items-center justify-end gap-0.5 last:rounded-br-[12px]"><span className="text-sm font-bold opacity-60 mr-0.5">¥</span>{module.items.reduce((s, i) => s + (i.amount || 0), 0).toLocaleString()}</td></tr></tfoot></table></div>) : (
                <><div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">{module.services.map((service, idx) => {
                      ...
                      return (
                        <div key={service.id} draggable="true" onDragStart={(e) => { e.dataTransfer.setData('serviceIdx', idx.toString()); e.dataTransfer.setData('sourceModuleId', module.id); }} onDragOver={(e) => e.preventDefault()} onDrop={(e) => { e.preventDefault(); const sIdx = parseInt(e.dataTransfer.getData('serviceIdx')); const sourceModId = e.dataTransfer.getData('sourceModuleId'); if (sourceModId === module.id && sIdx !== idx) handleReorderTechServices(module.id, sIdx, idx); }} className={`group relative p-4 rounded-[12px] ${color.bg} border-2 transition-all duration-300 overflow-hidden ${service.checked ? 'border-[#BDD1FF]' : 'border-transparent hover:border-[#BDD1FF]/50'}`} style={{ boxShadow: '0 10px 20px rgba(0,0,0,0.03)' }}>
                          <div className={`absolute -right-1 -top-2 text-[3.5rem] font-black italic select-none ${color.num} font-num z-0`}>{displayId}</div>
                          <div className="absolute top-2 left-2 p-1 text-gray-300 opacity-0 group-hover:opacity-100 cursor-move transition-opacity z-20"><GripVertical className="w-3.5 h-3.5" /></div>
                          <button onClick={(e) => { e.stopPropagation(); handleRemoveTechService(module.id, idx); }} title="删除项目" className="absolute top-2 right-2 p-1 text-gray-300 hover:text-white hover:bg-red-500 rounded-lg transition-all opacity-0 group-hover:opacity-100 shadow-sm z-20"><Trash2 className="w-3.5 h-3.5" /></button>
                          <div className="flex items-start gap-3 relative z-10"><div onClick={() => toggleTechService(module.id, service.id)} className={`mt-0.5 w-5 h-5 rounded-[4px] flex items-center justify-center border-2 transition-all flex-shrink-0 cursor-pointer ${service.checked ? 'bg-[#2759CD] border-[#2759CD] text-white shadow-inner' : 'border-gray-300 bg-white group-hover:border-[#BDD1FF]'}`}>{service.checked && <Check className="w-3.5 h-3.5" />}</div><div className="flex-1 min-w-0"><div className="flex items-center gap-2 mb-1.5"><input className={`!p-0 !border-0 bg-transparent focus:ring-0 text-[14px] font-bold block w-full text-left transition-colors ${service.checked ? 'text-[#304166]' : 'text-[#333333]'}`} value={service.name} onChange={e => updateTechService(module.id, service.id, 'name', e.target.value)} /></div><input className="!p-0 !border-0 bg-transparent focus:ring-0 text-[11px] text-gray-500 text-left siding-relaxed siding-snug block w-full truncate font-normal" value={service.description} onChange={e => updateTechService(module.id, service.id, 'description', e.target.value)} /></div></div>
                        </div>
                      );
                    })}</div><div className="border border-gray-100 rounded-[12px] overflow-hidden shadow-sm bg-[#FAFAFA]"><div className="flex items-center gap-4 px-5 py-4 text-[13px] font-quote"><div className="flex items-center gap-2 font-normal text-left"><span className="text-gray-600 font-bold shrink-0">指导周期：</span><span className="text-gray-600 shrink-0">不少于（现场+远程）</span><input className="w-16 text-center font-bold text-[#2759CD] !py-1 font-quote !rounded-[8px]" value={module.details.minDays} onChange={e => updateTechModuleDetails(module.id, 'minDays', parseInt(e.target.value) || 0)} /><span className="text-gray-600">人天</span></div><div className="h-4 w-px bg-gray-300 mx-1"></div><div className="flex items-center gap-2 font-normal"><span className="text-gray-600 font-bold">内审员证书:</span><input className="w-16 text-center font-bold text-[#2759CD] !py-1 font-quote !rounded-[8px]" value={module.details.auditCerts} onChange={e => updateTechModuleDetails(module.id, 'auditCerts', parseInt(e.target.value) || 0)} /><span className="text-gray-600">份</span></div></div><div className="border-t border-[#D1E0FF] px-5 py-5 flex items-center justify-between"><span className="font-bold text-[#304166] text-[14px]">技术服务费用总计（含6%增值税）</span><div className="flex items-center justify-end text-[#2759CD] font-bold text-[18px] whitespace-nowrap font-quote transition-all min-w-[120px]"><span className="mr-0.5 font-quote opacity-60 text-sm">¥</span>{editingTechFeeId === module.id ? (<input autoFocus className="!border-0 !p-0 focus:ring-0 bg-transparent text-right font-bold text-[18px] w-28 placeholder:text-blue-200 font-quote" type="number" value={module.fee} onBlur={() => setEditingTechFeeId(null)} onChange={e => updateTechModuleFee(module.id, parseFloat(e.target.value) || 0)} />) : (<span onClick={() => setEditingTechFeeId(module.id)} className="cursor-text text-right font-bold font-quote">{module.fee.toLocaleString()}</span>)}</div></div></div></>
              )}
            </section>
          ))}
        </div>

        {/* Level 3: Notes and Contact */}
        <div className="space-y-[48px] mt-6">
          <section className="card">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={addRemark} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-[#BDD1FF] text-[#2759CD] px-3 py-1.5 rounded-[12px] hover:bg-[#EFF5FC] transition-all"><Plus className="w-3 h-3" /> 添加备注项</button>
            ...
            <div className="space-y-4">
              <div className={`p-4 border border-gray-100 rounded-[12px] bg-gray-50/50 group relative transition-all ${!isNote1Visible ? 'opacity-40 grayscale' : ''}`}>
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2 text-[#2759CD] font-bold text-xs uppercase tracking-widest"><Info className="w-3.5 h-3.5" /> 备注 1：规模说明</div>
                  <button onClick={() => setIsNote1Visible(!isNote1Visible)} className={`p-1 rounded-[8px] transition-colors ${isNote1Visible ? 'text-[#2759CD] hover:bg-blue-50' : 'text-gray-400 hover:bg-gray-200'}`}>{isNote1Visible ? <Eye className="w-4 h-4" /> : <Eye className="w-4 h-4 opacity-50 line-through" />}</button>
                </div>
                <div className="flex items-center gap-2 flex-wrap text-left justify-start">
                  ...
                  />
                  <input className="!w-20 !py-1 text-center font-normal text-[13px] text-[#2759CD] bg-white !rounded-[8px]" type="number" value={data.note1Count} onChange={e => setData({...data, note1Count: parseInt(e.target.value) || 0})} />
              ...
              <div className={`p-4 border border-gray-100 rounded-[12px] bg-gray-50/50 group relative transition-all ${!isNote2Visible ? 'opacity-40 grayscale' : ''}`}>
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2 text-emerald-600 font-bold text-xs uppercase tracking-widest"><CarTaxiFront className="w-3.5 h-3.5" /> 备注 2：食宿差旅</div>
                  <button onClick={() => setIsNote2Visible(!isNote2Visible)} className={`p-1 rounded-[8px] transition-colors ${isNote2Visible ? 'text-emerald-600 hover:bg-emerald-50' : 'text-gray-400 hover:bg-gray-200'}`}>{isNote2Visible ? <Eye className="w-4 h-4" /> : <Eye className="w-4 h-4 opacity-50 line-through" />}</button>
                </div>
                <div className="flex items-center gap-4 mb-3">
                  <button onClick={() => setData({...data, travelExpenseOption: 'excluded'})} className={`flex-1 py-2 text-xs font-bold rounded-[8px] border-2 transition-all ${data.travelExpenseOption === 'excluded' ? 'bg-emerald-600 border-emerald-600 text-white shadow-md' : 'bg-white border-gray-100 text-gray-400 hover:border-emerald-100'}`}>不包含差旅费</button>
                  <button onClick={() => setData({...data, travelExpenseOption: 'included'})} className={`flex-1 py-2 text-xs font-bold rounded-[8px] border-2 transition-all ${data.travelExpenseOption === 'included' ? 'bg-emerald-600 border-emerald-600 text-white shadow-md' : 'bg-white border-gray-100 text-gray-400 hover:border-emerald-100'}`}>已包含差旅费</button>
                </div>
                <div className="p-3 bg-white border border-emerald-50 rounded-[8px] text-left">
                  <p className="text-[13px] text-gray-600 leading-relaxed font-normal">
                    {data.travelExpenseOption === 'excluded' ? "本报价不包括现场审核及培训指导时发生的食宿和差旅费用，根据实际合理发生由客户承担/安排。" : "本报价包括现场审核及培训指导时发生的必要的食宿和差旅费用。"}
                  </p>
                </div>
              </div>
              ...
              {data.additionalRemarks.map((remark, index) => (
                <div key={index} className="p-4 border border-gray-100 rounded-[12px] bg-white group relative shadow-sm animate-fade-in text-left">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <div className="field-label !mb-0 text-[#2759CD] text-left">追加备注 {index + 1}</div>
                    <textarea 
                      className="w-full bg-transparent border-b border-dashed border-gray-200 focus:border-[#2759CD] outline-none p-0.5 text-[13px] font-normal text-gray-700 text-left resize-none" 
                      value={remark} 
                      rows={1}
                      onInput={(e) => { e.currentTarget.style.height = 'auto'; e.currentTarget.style.height = e.currentTarget.scrollHeight + 'px'; }}
            ...
            <section key={module.id} className={`card overflow-hidden relative group cursor-default transition-all duration-300 border-2 ${dragOverModuleId === module.id ? 'border-[#2759CD] scale-[1.01]' : 'border-transparent hover:border-[#BDD1FF]'}`} draggable="true" onDragStart={(e) => handleDragStart(e, module.id)} onDragOver={(e) => { e.preventDefault(); setDragOverModuleId(module.id); }} onDragLeave={() => setDragOverModuleId(null)} onDrop={(e) => handleModuleReorder(e, module.id)}>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => addBlockToModule(module.id, 'text')} className="flex items-center gap-1.5 text-[13px] font-bold border-2 border-[#BDD1FF] text-[#2759CD] px-3 py-1.5 rounded-[12px] hover:bg-[#EFF5FC] transition-all shadow-sm"><Type className="w-3.5 h-3.5" /> 添加文本</button>
            ...
            <div className="flex flex-col gap-4">
              <div className="card !p-5 bg-white flex flex-col mb-0 rounded-[16px]">
                ...
                <div className="grid grid-cols-1 gap-2 mb-4">
                  <button onClick={() => setShowPreview(true)} className="flex items-center justify-center gap-2 py-2.5 text-[14px] font-bold border-2 border-[#BDD1FF] text-[#2759CD] rounded-[8px] hover:bg-[#EFF5FC] transition-all shadow-none"><Eye className="w-4 h-4" /> 预览报价单</button>
                ...
                <div className="pt-4 border-t border-gray-50">
                  <div className="flex items-center gap-2 text-[#475569] font-bold mb-3">
                    <LayoutGrid className="w-4 h-4 text-[#2759CD]" />
              ...
              <div className="bg-white rounded-[16px] shadow-[0_8px_24px_rgba(0,0,0,0.04)] flex flex-col overflow-hidden">
                <div className="p-6 pb-2">
                  ...
                  <div className="space-y-6 flex-1">
                    <div className="flex justify-between items-start gap-4">
                      ...
                      <div className="text-right flex items-baseline leading-none pt-0.5 min-w-[120px] justify-end">
                        <span className="text-[#000000] text-[12px] mr-1 font-en font-bold">¥</span>
                        <span className="text-[18px] font-bold font-quote whitespace-nowrap text-[#000000]">{certTotal.toLocaleString()}</span>
                      </div>
                    </div>
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex flex-col text-left">
                      ...
                      <div className="text-right flex items-baseline leading-none pt-0.5 min-w-[120px] justify-end">
                        <span className="text-[#000000] text-[12px] mr-1 font-en font-bold">¥</span>
                        <span className="text-[18px] font-bold font-quote whitespace-nowrap text-[#000000]">{techTotal.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white px-[24px] pt-[20px] pb-[24px] flex justify-between items-start gap-4 mt-2 transition-all">
                  <div className="flex flex-col text-left">
                    <span className="text-[14px] text-[#2563EB] font-[700]">总计 (含6%增值税)</span>
                    <span className="text-[12px] text-[#94A3B8] font-en tracking-tight">Grand Total (6% Included)</span>
                  </div>
                  <div className="text-right flex items-start leading-none min-w-[120px] justify-end">
                    <span className="text-[#2563EB] text-[16px] mr-1 font-en font-black mt-1">¥</span>
                    <span className="text-[30px] font-black font-quote whitespace-nowrap text-[#1D4ED8]">{grandTotal.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <div className={`card !p-6 border-2 transition-all duration-300 bg-white shadow-[0_8px_24px_rgba(0,0,0,0.04)] mb-0 rounded-[16px] ${isDraggingOverLogos ? 'border-[#2759CD] bg-[#EFF5FC] scale-[1.02]' : 'border-transparent'}`} onDragOver={(e) => { e.preventDefault(); setIsDraggingOverLogos(true); }} onDragLeave={() => setIsDraggingOverLogos(false)} onDrop={() => setIsDraggingOverLogos(false)}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {COMMON_LOGOS.map(logo => (
                    <div key={logo.id} draggable onDragStart={(e) => e.dataTransfer.setData('logoUrl', logo.url)} className="p-2 border border-[#F1F5F9] rounded-[12px] bg-white shadow-none cursor-grab active:cursor-grabbing hover:border-[#BDD1FF] transition-all group flex flex-col items-center justify-center text-center overflow-hidden min-h-[85px]">
                      ...
                      <p className="text-[12px] text-[#94A3B8] font-medium font-zh siding-tight group-hover:text-[#2759CD] transition-colors line-clamp-2">{logo.name}</p>
                    </div>
                  ))}
                </div>
              </div>
              <div className={`card !p-6 border-2 transition-all duration-300 bg-white shadow-[0_8px_24px_rgba(0,0,0,0.04)] mb-0 rounded-[16px] ${isDraggingOverWebsites ? 'border-[#2759CD] bg-[#EFF5FC] scale-[1.02]' : 'border-transparent'}`} onDragOver={(e) => { e.preventDefault(); setIsDraggingOverWebsites(true); }} onDragLeave={() => setIsDraggingOverWebsites(false)} onDrop={() => setIsDraggingOverWebsites(false)}>
                ...
                <div className="grid grid-cols-2 gap-1">
                  {COMMON_WEBSITES.map(site => ( 
                    <a key={site.id} href={site.url} target="_blank" rel="noopener noreferrer" title={site.name} className="p-3 bg-transparent hover:bg-[#EFF6FF] rounded-[8px] transition-all group flex items-center gap-2">
                      ...
                      <p className="text-[12px] text-[#94A3B8] font-medium font-zh truncate w-full group-hover:text-[#2759CD] transition-colors tracking-[0.02em]">{site.name}</p>
                    </a> 
                  ))}
                </div>
              </div>
              <div className={`card !p-6 border-2 transition-all duration-300 bg-white shadow-[0_8px_24px_rgba(0,0,0,0.04)] mb-0 rounded-[16px] ${isDraggingOverSidebarTemplates ? 'border-[#2759CD] bg-[#EFF5FC] scale-[1.02]' : 'border-transparent'}`} onDragOver={(e) => { e.preventDefault(); setIsDraggingOverSidebarTemplates(true); }} onDragLeave={() => setIsDraggingOverSidebarTemplates(false)} onDrop={() => setIsDraggingOverSidebarTemplates(false)}>
                <SidebarTitle icon={LayoutTemplate} title="常用证书模板" />
                <div className="grid grid-cols-4 gap-2">
                  {COMMON_CERT_TEMPLATES.map(tmpl => { const Icon = tmpl.icon; return (<div key={tmpl.id} draggable onDragStart={(e) => e.dataTransfer.setData('templateUrl', tmpl.url)} onClick={() => addCommonTemplate(tmpl.url)} className={`aspect-square p-2 border border-gray-100 rounded-[12px] ${tmpl.bg} shadow-sm cursor-grab active:cursor-grabbing hover:shadow-md transition-all group flex flex-col items-center justify-center text-center relative border-transparent hover:border-[#BDD1FF]`} title={`点击添加 ${tmpl.name} 证书`}><Icon className="w-6 h-6 mb-1 transition-transform group-hover:scale-110" style={{ color: tmpl.color }} /><span className="text-[8px] font-black uppercase tracking-tighter leading-none" style={{ color: tmpl.color }}>{tmpl.name}</span><div className="absolute -top-1 -right-1 bg-white rounded-full p-0.5 shadow-sm opacity-0 group-hover:opacity-100 transition-opacity"><Plus className="w-3 h-3 text-[#2759CD]" /></div></div>); })}
                </div>
